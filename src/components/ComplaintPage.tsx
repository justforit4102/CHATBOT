...
const ComplaintPage: React.FC<Props> = ({ setCurrentPage }) => {
  ...
  const handleOK = () => {
    ...
    setSelectedMinistry("");
    setComplaintText("");
    setCurrentPage("home"); // Set current page to "home" when OK button is clicked
  };
  ...
  return (
    <div className="root-page" style={{ color: "white" }}>
      <div>
        <Typography
          variant="h2"
          sx={{ marginBottom: "4rem", fontFamily: "Lucida Console" }}
        >
          <span style={{ color: "#000000", marginRight: "0.5rem" }}>SUBMIT  </span>
          <span style={{ color: "#000000", marginRight: "0.5rem" }}>HERE </span>
          <span style={{ color: "#000000", marginRight: "0.5rem" }}>YOUR </span>
          <span style={{ color: "#000000", marginRight: "0.5rem" }}>COMPLAINT</span>
        </Typography>
      </div>
